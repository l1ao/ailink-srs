...
![](http://ossrs.net/gif/v1/sls.gif?site=github.com&path=/tmpl/k8s/kubernetes/l1ao/ailink-srs)
[![](https://github.com/l1ao/ailink-srs/actions/workflows/kubernetes.yml/badge.svg)](https://github.com/l1ao/ailink-srs/actions/workflows/kubernetes.yml)
...
**Step 2:** Click the <kbd>Use this template</kbd> to create your repository, then set the [secrets](https://github.com/l1ao/ailink-srs/settings/secrets/actions):

* `KUBECONFIG` is the config of K8s, for example, the content of `cat $HOME/.kube/config`.

**Step 3:** Run workflow from [Actions](https://github.com/l1ao/ailink-srs/actions/workflows/kubernetes.yml) to deploy to your K8s, for example, if your external IP is `81.70.125.89`:
